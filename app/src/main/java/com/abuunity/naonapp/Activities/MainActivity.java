...
import com.abuunity.naonapp.Adapters.StatusAdapter;
import com.abuunity.naonapp.Models.Status;
import com.abuunity.naonapp.Models.UserStatus;
import com.abuunity.naonapp.R;
import com.abuunity.naonapp.Models.User;
import com.abuunity.naonapp.Adapters.UsersAdapter;
import com.abuunity.naonapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.rvChats.showShimmerAdapter();
        binding.rvStatus.showShimmerAdapter();
        ...
        database.getReference().child("users").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                binding.rvChats.hideShimmerAdapter();
        ...
        database.getReference().child("stories").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    ...
                    binding.rvStatus.hideShimmerAdapter();
